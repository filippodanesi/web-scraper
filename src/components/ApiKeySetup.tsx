      ...
      <CardContent className="space-y-4 pt-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">
            You can get your API key from the <a href="https://www.firecrawl.dev/app/api-keys" target="_blank" rel="noopener noreferrer" className="underline">Firecrawl dashboard</a>.
          </p>
        </div>
      </CardContent>
